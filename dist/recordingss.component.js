...
var ChannelsComponent = (function () {
    ...
    ChannelsComponent.prototype.getRecordings = function () {
        var url = cfg._vdrurl + ':8002/recordings.json?start=0&limit=10';
        console.log(url);
        return this._http.get(url).map(function (res) { return res.json(); });
    };
    ChannelsComponent.prototype.dostream = function (rec) {
        var _lurl;
        if (this.isMobile()) {
...
//# sourceMappingURL=recordingss.component.js.map